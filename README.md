...
Microsoft Entra ID tenant (Azure Active Directory)
Microsoft Entra ID P2 license (required for PIM and Access Reviews)
Global Administrator or Privileged Role Administrator permissions to enable PIM
A test user account with no default role assignments


Tools Used
ToolPurposeMicrosoft Entra IDIdentity platform and PIM engineMicrosoft Entra ID P2Required license for PIM and Access ReviewsPrivileged Identity ManagementJust-in-time role activation and governanceMicrosoft SentinelSIEM for identity threat detection (Phase 5 in progress)
...
Phase 2 Create Eligible Assignment
...
Phase 4 Audit Trail and Compliance Logging
...
Phase 5  Microsoft Sentinel Integration (In Progress)
